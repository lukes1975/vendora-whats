-- Fix the update_setup_completion function with proper security
DROP FUNCTION IF EXISTS public.update_setup_completion();
...
DROP TRIGGER IF EXISTS trigger_update_setup_completion ON public.user_setup_progress;
